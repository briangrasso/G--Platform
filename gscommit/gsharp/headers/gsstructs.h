...
// the point of the struct is to create referenceable values = macros??
// the point of the STATIC struct is to create global variables 
...
struct UserInfo
{
	...
	UserInfo(const char* Username, const char* Password) {
		...
		for(int passName = 0; passName < 10; ++passName){
			Username = Username + newUser[passName];
		}
		for(int passWord = 0; passWord < 10; ++passWord){
...
struct ToneTable {
		...
		ToneTable(short int tone1, short int tone2, short int tone3, short int tone4, short int tone5, short int tone6, 
			...
			short int tone27, short int tone28, short int tone29, short int tone30, short int tone31, 	// this establishes the memory
			...
			AO3(tone31), DO3(tone32), GO4(tone33), CO3(tone34), EO4(tone35), AO4(tone36), 		// this is how that memory is referenced
...
// do I have the ability here to instantiate separate ToneTables according to key?	-- use Key()
		short int GS1 = 10, \
			...
			Df1 = 17, Df2 = 26, Df3 = 40, Df4 = 55, Df5 = 60, Df6 = 69, Df7 = 89, Df8 = 98, Df9 = 112, 				// This is the value of 
			Ef1 = 9, Ef2 = 29, Ef3 = 38, Ef4 = 52, Ef5 = 67, Ef6 = 72, Ef7 = 81, Ef8 = 101, Ef9 = 110, Eft = 124, 		// what is stored in the memory
		...
		short int ToneArray[126]{
		 EO1, FO1, FS1, GO2, GS2, AO3, Bf3, BO4, CO4, Df4, DO5, Ef5, EO7, FO7, FS7, GO8, GS8, AO9, Bf9, BOt, COt,	// This is a representation of their physical
		 AO1, Bf1, BO2, CO2, Df2, DO3, Ef3, EO5, FO5, FS5, GO6, GS6, AO7, Bf7, BO8, CO8, Df8, DO9, Ef9, EOe, FOe,		// relationships to each other
...
// I can increment the fretBoard to CALCULATE the values of tones and chords per key's location (+/-) with respect to G#
		...
		short int vav = fretBoard[0][3] + fretBoard[1][3] + fretBoard[2][6] + fretBoard[3][5] + fretBoard[4][4] + fretBoard[5][3];		// This is how the tones
		short int zayin = fretBoard[0][10] + fretBoard[1][10] + fretBoard[2][10] + fretBoard[3][12] + fretBoard[4][13] + fretBoard[5][11];	// are combined to create chords
