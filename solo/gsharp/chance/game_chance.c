...
if(fd == -1)
fatal("int update_player_data() while opening file");
read(fd, &read_uid, 4);
...
printf("Your currently have the high score of %u credits!\n", player.highscore);
printf("===============================================================\n\n");
}
...
scanf("%d", &wager);	// ~~~~~~~~~!!!!!!!!!!!scan field - choose data type, and storage location
if(wager < 1){
...
if(player.credits == 0){
printf("You don't have many credits to wager!\n\n");
return -1;
}
