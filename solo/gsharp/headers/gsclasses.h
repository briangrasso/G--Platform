...
void MakeUser(/*string passString*/) { // need to make prototype to pass Admin.newUser to struct before saving
    ...
    if (Admin.newUser != "new") {
		...
		string openMethod = "C:\\Users\\brian\\masm\\solo\\gsharp\\usrfiles\\" + *filePointer;
...
int Core() {
cout << "before system call in Core()" << endl;
system(/*cl C:\\Users\\brian\\masm\\gsharp\\core\\coreValues.cpp;*/"C:\\Users\\brian\\masm\\solo\\gsharp\\core\\coreValues.exe");
// I don't have to run core to access ToneTable members
// need to move
cout << "after system call in Core()" << endl;
...
void Verify() {
    ...
    string methodOpen = "C:\\Users\\brian\\masm\\solo\\gsharp\\usrfiles\\" + *initPoint;
